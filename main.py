...
def main():
    ...
    for b, depth in zip(b_values, depth_values):
        ...
        # Step 1: Build the Vocabulary Tree
        ...
        # Step 2: Assign visual words to database images
        ...
        # Step 4: Process query images and rank database objects
        top1_correct = 0
        top5_correct = 0
        for obj_num in range(1, num_objects + 1):
